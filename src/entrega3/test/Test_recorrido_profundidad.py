...
if __name__ == '__main__':
    rrss2: Red_social = Red_social.parse('resourcestest/usuarios.txt', 'resourcestest/relaciones.txt')
    r:Recorrido_en_profundidad[Usuario,Relacion] = Recorrido_en_profundidad.of(rrss2)
    
    
    source:Usuario = rrss2.usuarios_dni['25143909I']
    
    r.traverse(source)
    
    target: Usuario =  rrss2.usuarios_dni['76929765H']
