...
def test5():
    ...
    print(encoding(absolute_path('resources1/lin_quijote.txt')))
    print(lista_de_fichero(absolute_path('datos/datos_2.txt'),encoding='utf-8',delim=","))
    
def test6():
    print(num_caracteres_no_delimitadores(absolute_path('resources1/quijote.txt'),encoding='utf-16'))
    print(numero_de_palabras_distintas(absolute_path('resources1/quijote.txt'),encoding='utf-16'))
