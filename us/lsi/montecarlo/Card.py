...
class Card:
    ...
    def name_of_file(self):
        r = None
        if(self.valor<9):
            r = "resources1/images/%s_of_%s.svg" % (nombre_valores[self.valor],nombre_palos[self.palo])
        else:
            switcher = {
            9 : "resources1/images/jack_of_%s.svg" % (nombre_palos[self.palo]),
            10: "resources1/images/queen_of_%s.svg" % (nombre_palos[self.palo]),
            11: "resources1/images/king_of_%s.svg" % (nombre_palos[self.palo]),
            12: "resources1/images/ace_of_%s.svg" % (nombre_palos[self.palo])
            }
