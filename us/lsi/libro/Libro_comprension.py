...
def palabras_huecas() -> set[str]:
    lns:list[str] = lineas_de_fichero(absolute_path("resources1/palabras_huecas.txt"))
...
def test1():
    print(encoding(absolute_path("resources1/quijote.txt")))
    print(str_iter(palabras_no_huecas(absolute_path("resources1/quijote.txt")),sep='\n'))
    print(str_dict(palabras_por_frecuencias(absolute_path("resources1/quijote.txt")),sep='\n'))
    
def test2():
    print(numero_de_palabras_distintas_no_huecas(absolute_path("resources1/quijote.txt")))
    
def test3():
    print(str_iter(palabras_por_frecuencias(absolute_path("resources1/quijote.txt")).items(),sep='\n',prefix='',suffix=''))
 
def test4():  
    print(str_iter(palabra_en_lineas(absolute_path("resources1/quijote.txt")).items(),sep='\n',prefix='',suffix=''))

def test5():
    print(palabras_frecuentes(absolute_path("resources1/quijote.txt"), 10))
