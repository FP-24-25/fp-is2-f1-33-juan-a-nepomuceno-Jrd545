...
if __name__ == '__main__':
    m2:Matriz_field[Fraction] = Matriz_field.of_file_field(absolute_path('/resources1/matriz2.txt'),FractionField())
    print(m2)
    print(m2.es_antisimetrica)
    print('_________________')
    m3:Matriz_field[Fraction] = Matriz_field.of_file_field(absolute_path('/resources1/matriz3.txt'),FractionField())
    print(m2+m3)
    print(m2-m3)
    print(m2*m3)
    print(m2**5)
    print(m3.traza)
    print('_________________')
    m4:Matriz_field[Fraction] = Matriz_field.of_file_field(absolute_path('/resources1/matriz6.txt'),FractionField())
    print(m4.solve)
    print('_________________')
    print(m4)
    print('_________________')
