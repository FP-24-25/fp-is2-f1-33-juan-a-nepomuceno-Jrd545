...
def getPolylinePatternGoogle()->str:
    return File.read("../../../resources1/GooglePolylinePattern.html")
    
def getMarkersPatternGoogle()->str:
    return File.read("../../../resources1/GoogleMarkersPattern.html")
...
def getPolylinePatternBing()->str:
    return File.read("../../../resources1/BingPolylinePattern.html")

def getMarkersPatternBing()->str:
    return File.read("../../../resources1/BingMarkersPattern.html")
